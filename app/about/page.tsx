...
export default function About() {
  return (
    <div className="pt-36">
      ...
      <div className="container flex flex-col items-center max-w-4xl mx-auto mt-10">
        <h3 className="mb-2 text-lg font-semibold md:text-xl lg:text-2xl">
          ...
          exciting turn when I embraced the incredible experience of motherhood,
          which led to a career change and the inspiration to start this blog.
        </h3>
        <p className="mb-4 text-gray-700 text-md md:text-lg">
